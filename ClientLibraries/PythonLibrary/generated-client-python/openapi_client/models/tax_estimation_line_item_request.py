...
class TaxEstimationLineItemRequest(BaseModel):
    """
    ...
    item_code: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="The unique identifier (in Chargebee) of the product corresponding to the line item. If the line item corresponds to a one-off charge, then this identifier is not provided.", alias="itemCode")
    ...
    discount_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The discount applied to this line item.", alias="discountAmount")
    is_tax_inclusive: StrictBool = Field(description="Indicates whether (`amount` - `discountAmount`)  is inclusive of taxes.", alias="isTaxInclusive")
    ...
    __properties: ClassVar[List[str]] = ["number", "itemCode", "description", "quantity", "unitPrice", "amount", "discountAmount", "isTaxInclusive", "taxIdentifiers"]
