...
// AssertAddressValidationResponseRequired checks if the required fields are not zero-ed
func AssertAddressValidationResponseRequired(obj AddressValidationResponse) error {
...
// AssertAddressValidationResponseConstraints checks if the values respects the defined constraints
func AssertAddressValidationResponseConstraints(obj AddressValidationResponse) error {
	return nil
}
