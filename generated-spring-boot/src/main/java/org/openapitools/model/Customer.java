...
import org.openapitools.model.CustomerLocationEvidence;
import org.openapitools.model.FieldItem;
...
public class Customer {
  ...
  @Valid
  private List<@Valid FieldItem> taxIdentifiers = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, customer.name) &&
        ...
        equalsNullable(this.taxRegistrationNumber, customer.taxRegistrationNumber) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, customerCode, address, hashCodeNullable(taxRegistrationNumber), taxIdentifiers, hasNexus, locationEvidence);
  }
