...
class AddressApi:
    ...
    @validate_call
    def check_address_taxability(
        self,
        check_address_taxability_request: Optional[CheckAddressTaxabilityRequest] = None,
        ...
        :type check_address_taxability_request: CheckAddressTaxabilityRequest
        ...
        _param = self._check_address_taxability_serialize(
            check_address_taxability_request=check_address_taxability_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CheckAddressTaxabilityResponse",
    ...
    @validate_call
    def check_address_taxability_with_http_info(
        self,
        check_address_taxability_request: Optional[CheckAddressTaxabilityRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckAddressTaxabilityResponse]:
        """Check taxability
    ...
    @validate_call
    def check_address_taxability_without_preload_content(
        self,
        check_address_taxability_request: Optional[CheckAddressTaxabilityRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _check_address_taxability_serialize(
        self,
        check_address_taxability_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if check_address_taxability_request is not None:
            _body_params = check_address_taxability_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/address/check-taxability',
    ...
    def validate_address(
        self,
        address_validation_request: Optional[AddressValidationRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type address_validation_request: AddressValidationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._validate_address_serialize(
            address_validation_request=address_validation_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _validate_address_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if address_validation_request is not None:
            _body_params = address_validation_request
