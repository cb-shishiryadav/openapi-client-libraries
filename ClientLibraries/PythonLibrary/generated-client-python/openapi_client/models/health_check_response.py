...
class HealthCheckResponse(BaseModel):
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(default=None, description="The description of the health status returned by the Service Adapter.")
    status: HealthStatus
    components: List[HealthCheckComponent] = Field(description="List of health status details for each component reported by the Service Adapter.")
    time: datetime = Field(description="The timestamp of the health status reported by the Service Adapter.")
    __properties: ClassVar[List[str]] = ["version", "description", "status", "components", "time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": [HealthCheckComponent.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None,
            "time": obj.get("time")
        })
        return _obj
