...
// All allowed values of TaxExemptType enum
...
func (v *TaxExemptType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := TaxExemptType(value)
	for _, existing := range AllowedTaxExemptTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid TaxExemptType", value)
}
...
func NewTaxExemptTypeFromValue(v string) (*TaxExemptType, error) {
	...
	if ev.IsValid() {
		...
		return nil, fmt.Errorf("invalid value '%v' for TaxExemptType: valid values are %v", v, AllowedTaxExemptTypeEnumValues)
	}
}
...
// Ptr returns reference to TaxExemptType value
func (v TaxExemptType) Ptr() *TaxExemptType {
	return &v
}

type NullableTaxExemptType struct {
	value *TaxExemptType
	isSet bool
}

func (v NullableTaxExemptType) Get() *TaxExemptType {
	return v.value
}

func (v *NullableTaxExemptType) Set(val *TaxExemptType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxExemptType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxExemptType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxExemptType(val *TaxExemptType) *NullableTaxExemptType {
	return &NullableTaxExemptType{value: val, isSet: true}
}

func (v NullableTaxExemptType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxExemptType) UnmarshalJSON(src []byte) error {
	v.isSet = true
