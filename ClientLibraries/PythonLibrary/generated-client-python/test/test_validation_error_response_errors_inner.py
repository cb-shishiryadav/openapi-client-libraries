...
class TestValidationErrorResponseErrorsInner(unittest.TestCase):
    """ValidationErrorResponseErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationErrorResponseErrorsInner:
        """Test ValidationErrorResponseErrorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationErrorResponseErrorsInner`
        """
        model = ValidationErrorResponseErrorsInner()
        if include_optional:
            return ValidationErrorResponseErrorsInner(
                entity = 'customer',
                entity_field = 'lineItems[0].taxIdentifiers[0].value',
                code = 'INVALID_OPERATION',
                message = 'Invalid tax code provided.',
                help_url = 'https://apidocs.chargebee.com#Authentication'
            )
        else:
            return ValidationErrorResponseErrorsInner(
                code = 'INVALID_OPERATION',
    ...
    def testValidationErrorResponseErrorsInner(self):
        """Test ValidationErrorResponseErrorsInner"""
