...
func (s *AuthenticationAPIService) ValidateCredentials(ctx context.Context) (ImplResponse, error) {
	// TODO - update ValidateCredentials with the required logic for this service method.
	...
	// TODO: Uncomment the next line to return response Response(200, CredentialValidationResponse{}) or use other options such as http.Ok ...
	// return Response(200, CredentialValidationResponse{}), nil

	// TODO: Uncomment the next line to return response Response(401, CredentialValidationResponse{}) or use other options such as http.Ok ...
	// return Response(401, CredentialValidationResponse{}), nil
	...
	return Response(http.StatusNotImplemented, nil), errors.New("ValidateCredentials method not implemented")
}
