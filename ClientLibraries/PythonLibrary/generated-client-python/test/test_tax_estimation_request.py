...
class TestTaxEstimationRequest(unittest.TestCase):
    """TaxEstimationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxEstimationRequest:
        """Test TaxEstimationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxEstimationRequest`
        """
        model = TaxEstimationRequest()
        if include_optional:
            return TaxEstimationRequest(
                ...
                currency = '012',
                line_items = [
                    openapi_client.models.tax_estimation_line_item_request.TaxEstimationLineItemRequest(
                        number = 1, 
                        item_code = '', 
                        description = '', 
                        quantity = 0, 
    ...
    def testTaxEstimationRequest(self):
        """Test TaxEstimationRequest"""
