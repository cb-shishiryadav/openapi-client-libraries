...
class TestCheckAddressTaxabilityRequest(unittest.TestCase):
    """CheckAddressTaxabilityRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckAddressTaxabilityRequest:
        """Test CheckAddressTaxabilityRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckAddressTaxabilityRequest`
        """
        model = CheckAddressTaxabilityRequest()
        if include_optional:
            return CheckAddressTaxabilityRequest(
    ...
    def testCheckAddressTaxabilityRequest(self):
        """Test CheckAddressTaxabilityRequest"""
