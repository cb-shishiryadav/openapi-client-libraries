...
class TestAddressValidationRequest(unittest.TestCase):
    """AddressValidationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddressValidationRequest:
        """Test AddressValidationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddressValidationRequest`
        """
        model = AddressValidationRequest()
        if include_optional:
    ...
    def testAddressValidationRequest(self):
        """Test AddressValidationRequest"""
