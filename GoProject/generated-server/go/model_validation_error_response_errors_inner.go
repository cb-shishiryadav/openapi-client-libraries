...
// AssertValidationErrorResponseErrorsInnerRequired checks if the required fields are not zero-ed
func AssertValidationErrorResponseErrorsInnerRequired(obj ValidationErrorResponseErrorsInner) error {
...
// AssertValidationErrorResponseErrorsInnerConstraints checks if the values respects the defined constraints
func AssertValidationErrorResponseErrorsInnerConstraints(obj ValidationErrorResponseErrorsInner) error {
	return nil
}
