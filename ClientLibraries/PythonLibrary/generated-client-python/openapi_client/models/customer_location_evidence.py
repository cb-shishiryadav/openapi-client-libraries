...
class CustomerLocationEvidence(BaseModel):
    """
    Represent the properties for customer location evidence.
    """ # noqa: E501
    ip: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="The customer's IP to determine which country the customer belongs to.")
    bin: Optional[Annotated[str, Field(strict=True, max_length=15)]] = Field(default=None, description="The country associated with a card by using the first or last 6 digits of the Bank Identification Number.")
    payment_country_code: Optional[Annotated[str, Field(strict=True, max_length=5)]] = Field(default=None, description="Identifies the country code associated with the payment method.", alias="paymentCountryCode")
    __properties: ClassVar[List[str]] = ["ip", "bin", "paymentCountryCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ip": obj.get("ip"),
            "bin": obj.get("bin"),
            "paymentCountryCode": obj.get("paymentCountryCode")
        })
        return _obj
