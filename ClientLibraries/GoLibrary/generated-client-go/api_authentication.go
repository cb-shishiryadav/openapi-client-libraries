...
func (r ApiValidateCredentialsRequest) Execute() (*CredentialValidationResponse, *http.Response, error) {
...
*/
func (a *AuthenticationAPIService) ValidateCredentials(ctx context.Context) ApiValidateCredentialsRequest {
	return ApiValidateCredentialsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *AuthenticationAPIService) ValidateCredentialsExecute(r ApiValidateCredentialsRequest) (*CredentialValidationResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CredentialValidationResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthenticationAPIService.ValidateCredentials")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/credentials/validate"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 401 {
			var v CredentialValidationResponse
