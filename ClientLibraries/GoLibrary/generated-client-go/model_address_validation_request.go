...
// checks if the AddressValidationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressValidationRequest{}

// AddressValidationRequest The verification request containing the address. The following fields are mandatory -   - line1   - city   - postalCode   - state   - country
...
func (o AddressValidationRequest) MarshalJSON() ([]byte, error) {
...
func (o AddressValidationRequest) ToMap() (map[string]interface{}, error) {
...
type NullableAddressValidationRequest struct {
	value *AddressValidationRequest
	isSet bool
}

func (v NullableAddressValidationRequest) Get() *AddressValidationRequest {
	return v.value
}

func (v *NullableAddressValidationRequest) Set(val *AddressValidationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressValidationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressValidationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressValidationRequest(val *AddressValidationRequest) *NullableAddressValidationRequest {
	return &NullableAddressValidationRequest{value: val, isSet: true}
}

func (v NullableAddressValidationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressValidationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
