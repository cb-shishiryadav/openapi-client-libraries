...
class TestCheckAddressTaxabilityResponse(unittest.TestCase):
    """CheckAddressTaxabilityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CheckAddressTaxabilityResponse:
        """Test CheckAddressTaxabilityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CheckAddressTaxabilityResponse`
        """
        model = CheckAddressTaxabilityResponse()
        if include_optional:
    ...
    def testCheckAddressTaxabilityResponse(self):
        """Test CheckAddressTaxabilityResponse"""
