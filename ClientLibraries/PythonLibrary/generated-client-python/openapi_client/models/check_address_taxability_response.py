...
class CheckAddressTaxabilityResponse(BaseModel):
    """
    CheckAddressTaxabilityResponse
    """ # noqa: E501
    is_taxable: StrictBool = Field(description="The taxability of the address.", alias="isTaxable")
    __properties: ClassVar[List[str]] = ["isTaxable"]
