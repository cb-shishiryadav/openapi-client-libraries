...
// AssertCredentialValidationResponseRequired checks if the required fields are not zero-ed
func AssertCredentialValidationResponseRequired(obj CredentialValidationResponse) error {
...
// AssertCredentialValidationResponseConstraints checks if the values respects the defined constraints
func AssertCredentialValidationResponseConstraints(obj CredentialValidationResponse) error {
	return nil
}
