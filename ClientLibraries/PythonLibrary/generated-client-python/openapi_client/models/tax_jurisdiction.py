...
class TaxJurisdiction(BaseModel):
    ...
    """ # noqa: E501
    code: Annotated[str, Field(strict=True, max_length=50)] = Field(description="The jurisdiction code.")
    type: TaxJurisdictionType
    name: Annotated[str, Field(strict=True, max_length=50)] = Field(description="The jurisdiction name.")
    __properties: ClassVar[List[str]] = ["code", "type", "name"]
