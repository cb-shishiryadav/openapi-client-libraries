...
class Invoice(BaseModel):
    ...
    """ # noqa: E501
    invoice_id: StrictStr = Field(description="The unique identifier of the invoice in the Tax Service Adapter or the Tax Service Provider.", alias="invoiceId")
    ...
    __properties: ClassVar[List[str]] = ["invoiceId", "invoiceCode", "documentDateTime", "taxDateTime", "status", "currency", "seller", "customer", "subtotal", "exemptAmount", "discountAmount", "taxableAmount", "taxAmount", "total", "lineItems"]
