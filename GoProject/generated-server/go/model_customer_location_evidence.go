...
// AssertCustomerLocationEvidenceRequired checks if the required fields are not zero-ed
func AssertCustomerLocationEvidenceRequired(obj CustomerLocationEvidence) error {
	return nil
}

// AssertCustomerLocationEvidenceConstraints checks if the values respects the defined constraints
func AssertCustomerLocationEvidenceConstraints(obj CustomerLocationEvidence) error {
	return nil
}
