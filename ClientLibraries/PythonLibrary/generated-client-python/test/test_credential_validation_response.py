...
class TestCredentialValidationResponse(unittest.TestCase):
    """CredentialValidationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CredentialValidationResponse:
        """Test CredentialValidationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CredentialValidationResponse`
        """
        model = CredentialValidationResponse()
        if include_optional:
    ...
    def testCredentialValidationResponse(self):
        """Test CredentialValidationResponse"""
