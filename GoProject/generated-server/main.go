...
func main() {
	...
	AddressAPIService := openapi.NewAddressAPIService()
	AddressAPIController := openapi.NewAddressAPIController(AddressAPIService)
	...
	CreditNoteAPIService := openapi.NewCreditNoteAPIService()
	CreditNoteAPIController := openapi.NewCreditNoteAPIController(CreditNoteAPIService)

	HealthAPIService := openapi.NewHealthAPIService()
	HealthAPIController := openapi.NewHealthAPIController(HealthAPIService)

	InvoiceAPIService := openapi.NewInvoiceAPIService()
	InvoiceAPIController := openapi.NewInvoiceAPIController(InvoiceAPIService)

	TaxEstimateAPIService := openapi.NewTaxEstimateAPIService()
	TaxEstimateAPIController := openapi.NewTaxEstimateAPIController(TaxEstimateAPIService)

	router := openapi.NewRouter(AddressAPIController, AuthenticationAPIController, CreditNoteAPIController, HealthAPIController, InvoiceAPIController, TaxEstimateAPIController)
