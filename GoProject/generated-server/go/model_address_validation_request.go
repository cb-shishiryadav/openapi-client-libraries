...
// AssertAddressValidationRequestRequired checks if the required fields are not zero-ed
func AssertAddressValidationRequestRequired(obj AddressValidationRequest) error {
...
// AssertAddressValidationRequestConstraints checks if the values respects the defined constraints
func AssertAddressValidationRequestConstraints(obj AddressValidationRequest) error {
