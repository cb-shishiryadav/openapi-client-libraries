...
class TestCustomerLocationEvidence(unittest.TestCase):
    """CustomerLocationEvidence unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomerLocationEvidence:
        """Test CustomerLocationEvidence
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomerLocationEvidence`
        """
        model = CustomerLocationEvidence()
        if include_optional:
            return CustomerLocationEvidence(
                ip = '',
                bin = '',
    ...
    def testCustomerLocationEvidence(self):
        """Test CustomerLocationEvidence"""
