...
class Invoice(Model):
    ...
    def __init__(self, invoice_id=None, invoice_code=None, document_date_time=None, tax_date_time=None, status=None, currency=None, seller=None, customer=None, subtotal=None, exempt_amount=None, discount_amount=None, taxable_amount=None, tax_amount=None, total=None, line_items=None):  # noqa: E501
        """Invoice - a model defined in OpenAPI

        :param invoice_id: The invoice_id of this Invoice.  # noqa: E501
        :type invoice_id: str
        :param invoice_code: The invoice_code of this Invoice.  # noqa: E501
        :type invoice_code: str
        :param document_date_time: The document_date_time of this Invoice.  # noqa: E501
        :type document_date_time: datetime
        :param tax_date_time: The tax_date_time of this Invoice.  # noqa: E501
        ...
        :type subtotal: float
        :param exempt_amount: The exempt_amount of this Invoice.  # noqa: E501
        :type exempt_amount: float
        :param discount_amount: The discount_amount of this Invoice.  # noqa: E501
        :type discount_amount: float
        :param taxable_amount: The taxable_amount of this Invoice.  # noqa: E501
    ...
    def invoice_code(self) -> str:
        """Gets the invoice_code of this Invoice.

        The unique identifier of the invoice in Chargebee.  # noqa: E501

        :return: The invoice_code of this Invoice.
        :rtype: str
        """
    ...
    def invoice_code(self, invoice_code: str):
        """Sets the invoice_code of this Invoice.

        The unique identifier of the invoice in Chargebee.  # noqa: E501

        :param invoice_code: The invoice_code of this Invoice.
        :type invoice_code: str
        """
    ...
    def document_date_time(self) -> datetime:
        """Gets the document_date_time of this Invoice.
        ...
        :return: The document_date_time of this Invoice.
        :rtype: datetime
        """
    ...
    def document_date_time(self, document_date_time: datetime):
        """Sets the document_date_time of this Invoice.

        The date and time at which the invoice was generated in Chargebee. For example, if the value is 2022-10-28T15:36:28.129+05:30, then the timestamp represents October 28, 2022, at 15:36:28.129, with an offset of +05:30. This means that the time represented is 5 hours and 30 minutes ahead of UTC/GMT.In the case of a merchant site located in UTC, these data types would send a timestamp in the format 2022-11-11T15:40:44.65Z. This timestamp represents November 11, 2022, at 15:40:44.65, with the 'Z' indicating that the time is in UTC.  # noqa: E501

        :param document_date_time: The document_date_time of this Invoice.
        :type document_date_time: datetime
        """
    ...
    def tax_date_time(self) -> datetime:
        """Gets the tax_date_time of this Invoice.
        ...
        :return: The tax_date_time of this Invoice.
        :rtype: datetime
        """
    ...
    def tax_date_time(self, tax_date_time: datetime):
        """Sets the tax_date_time of this Invoice.

        The date and time at which the tax was applicable in Chargebee. For example, if the value is 2022-10-28T15:36:28.129+05:30, then the timestamp represents October 28, 2022, at 15:36:28.129, with an offset of +05:30. This means that the time represented is 5 hours and 30 minutes ahead of UTC/GMT.In the case of a merchant site located in UTC, these data types would send a timestamp in the format 2022-11-11T15:40:44.65Z. This timestamp represents November 11, 2022, at 15:40:44.65, with the 'Z' indicating that the time is in UTC.  # noqa: E501

        :param tax_date_time: The tax_date_time of this Invoice.
        :type tax_date_time: datetime
        """
    ...
    def seller(self) -> Seller:
        """Gets the seller of this Invoice.


        :return: The seller of this Invoice.
        :rtype: Seller
        """
        return self._seller
    ...
    def seller(self, seller: Seller):
        ...
        :param seller: The seller of this Invoice.
        :type seller: Seller
        """
        if seller is None:
    ...
    def exempt_amount(self) -> float:
        """Gets the exempt_amount of this Invoice.

        The part of the `subtotal` that is exempted from tax.  # noqa: E501

        :return: The exempt_amount of this Invoice.
        :rtype: float
        """
    ...
    def exempt_amount(self, exempt_amount: float):
        """Sets the exempt_amount of this Invoice.

        The part of the `subtotal` that is exempted from tax.  # noqa: E501

        :param exempt_amount: The exempt_amount of this Invoice.
        :type exempt_amount: float
        """
    ...
    def taxable_amount(self) -> float:
        """Gets the taxable_amount of this Invoice.

        The part of the `subtotal` that is taxable.  # noqa: E501

        :return: The taxable_amount of this Invoice.
        :rtype: float
        """
    ...
    def taxable_amount(self, taxable_amount: float):
        """Sets the taxable_amount of this Invoice.

        The part of the `subtotal` that is taxable.  # noqa: E501

        :param taxable_amount: The taxable_amount of this Invoice.
        :type taxable_amount: float
        """
