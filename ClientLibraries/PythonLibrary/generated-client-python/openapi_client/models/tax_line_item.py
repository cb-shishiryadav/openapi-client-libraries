...
class TaxLineItem(BaseModel):
    ...
    """ # noqa: E501
    number: Annotated[int, Field(strict=True, ge=1)] = Field(description="Index or serial number of this tax line item.")
    jurisdiction: TaxJurisdiction
    name: StrictStr = Field(description="The name of the tax applied.")
    rate: Union[Annotated[float, Field(le=100, strict=True)], Annotated[int, Field(le=100, strict=True)]] = Field(description="The tax rate expressed in percentage.")
    taxable_amount: Union[StrictFloat, StrictInt] = Field(description="The part of the line item's `subtotal` that is taxable under this jurisdiction.", alias="taxableAmount")
    tax_amount: Union[StrictFloat, StrictInt] = Field(description="The tax payable for the line item under this jurisdiction.", alias="taxAmount")
    __properties: ClassVar[List[str]] = ["number", "jurisdiction", "name", "rate", "taxableAmount", "taxAmount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jurisdiction": TaxJurisdiction.from_dict(obj["jurisdiction"]) if obj.get("jurisdiction") is not None else None,
            "name": obj.get("name"),
            "rate": obj.get("rate"),
