...
**Line3** | Pointer to **string** | Third line of the street address | [optional] 
**City** | Pointer to **string** | The city of the address | [optional] 
**State** | Pointer to **string** | The state of the address following the ISO 3166-2 state/province code without the country prefix. | [optional] 
**PostalCode** | Pointer to **string** | Postal Code / Zip Code of the address. | [optional] 
**Country** | Pointer to **string** | The country of the address following the ISO 3166-1 alpha-2 standard. | [optional] 
