...
class TestTaxJurisdictionType(unittest.TestCase):
    """TaxJurisdictionType unit test stubs"""
    ...
    def testTaxJurisdictionType(self):
        """Test TaxJurisdictionType"""
        # inst = TaxJurisdictionType()
