...
class Customer(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(strict=True, max_length=50)]] = Field(default=None, description="The name of the Customer in Chargebee.")
    customer_code: Annotated[str, Field(strict=True, max_length=50)] = Field(description="The unique identifier for the Customer in Chargebee.", alias="customerCode")
    address: Address
    tax_registration_number: Optional[Annotated[str, Field(strict=True, max_length=30)]] = Field(default=None, description="The tax registration number of a business in a country. For example, this is the GSTIN for India or the VAT number for EU or Australia.", alias="taxRegistrationNumber")
    tax_identifiers: Optional[Annotated[List[FieldItem], Field(max_length=10)]] = Field(default=None, description="It represents the information related to the customer's tax identifiers. This includes details such as exemption status etc.", alias="taxIdentifiers")
    has_nexus: Optional[StrictBool] = Field(default=None, description="Determines whether a tax nexus exists between the Seller and the tax authority at the address provided.", alias="hasNexus")
    location_evidence: Optional[CustomerLocationEvidence] = Field(default=None, alias="locationEvidence")
    __properties: ClassVar[List[str]] = ["name", "customerCode", "address", "taxRegistrationNumber", "taxIdentifiers", "hasNexus", "locationEvidence"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of location_evidence
        if self.location_evidence:
            _dict['locationEvidence'] = self.location_evidence.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hasNexus": obj.get("hasNexus"),
            "locationEvidence": CustomerLocationEvidence.from_dict(obj["locationEvidence"]) if obj.get("locationEvidence") is not None else None
        })
        return _obj
