...
class CreditNoteRequest(BaseModel):
    ...
    line_items: Optional[Annotated[List[InvoiceLineItem], Field(min_length=1, max_length=1250)]] = Field(default=None, alias="lineItems")
    __properties: ClassVar[List[str]] = ["creditNoteCode", "invoiceCode", "invoiceId", "creditNoteType", "documentDateTime", "taxDateTime", "currency", "seller", "customer", "total", "exemptAmount", "discountAmount", "taxableAmount", "taxAmount", "roundingAmount", "lineItems"]
