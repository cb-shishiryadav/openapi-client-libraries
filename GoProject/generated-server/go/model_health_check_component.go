...
// AssertHealthCheckComponentRequired checks if the required fields are not zero-ed
func AssertHealthCheckComponentRequired(obj HealthCheckComponent) error {
...
// AssertHealthCheckComponentConstraints checks if the values respects the defined constraints
func AssertHealthCheckComponentConstraints(obj HealthCheckComponent) error {
	return nil
}
