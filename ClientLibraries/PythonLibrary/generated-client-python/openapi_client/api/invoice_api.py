...
class InvoiceApi:
    ...
    def commit_invoice(
        self,
        invoice_id: Annotated[StrictStr, Field(description="The unique identifier of the invoice at the Tax Service Adapter or Tax Service Provider.")],
        ...
        :param invoice_id: The unique identifier of the invoice at the Tax Service Adapter or Tax Service Provider. (required)
        :type invoice_id: str
    ...
    def _commit_invoice_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/invoices/{invoiceId}/commit',
    ...
    def create_invoice(
        self,
        invoice_request: Optional[InvoiceRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type invoice_request: InvoiceRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def fetch_invoice(
        ...
        _param = self._fetch_invoice_serialize(
            invoice_id=invoice_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_invoice_with_http_info(
        self,
        invoice_id: Annotated[StrictStr, Field(description="The unique identifier of the invoice at the Tax Service Adapter or Tax Service Provider.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fetch_invoice_without_preload_content(
        self,
        invoice_id: Annotated[StrictStr, Field(description="The unique identifier of the invoice at the Tax Service Adapter or Tax Service Provider.")],
        _request_timeout: Union[
            None,
    ...
    def _void_invoice_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/invoices/{invoiceId}/void',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
