...
// AssertBasicErrorResponseRequired checks if the required fields are not zero-ed
func AssertBasicErrorResponseRequired(obj BasicErrorResponse) error {
...
// AssertBasicErrorResponseConstraints checks if the values respects the defined constraints
func AssertBasicErrorResponseConstraints(obj BasicErrorResponse) error {
	return nil
}
