...
// AllowedAddressValidationStatusEnumValues is all the allowed values of AddressValidationStatus enum
var AllowedAddressValidationStatusEnumValues = []AddressValidationStatus{
	"VALID",
	"INVALID",
}

// validAddressValidationStatusEnumValue provides a map of AddressValidationStatuss for fast verification of use input
var validAddressValidationStatusEnumValues = map[AddressValidationStatus]struct{}{
	"VALID": {},
	"INVALID": {},
}
...
func (v AddressValidationStatus) IsValid() bool {
	_, ok := validAddressValidationStatusEnumValues[v]
	return ok
}
...
func NewAddressValidationStatusFromValue(v string) (AddressValidationStatus, error) {
	...
	return "", fmt.Errorf("invalid value '%v' for AddressValidationStatus: valid values are %v", v, AllowedAddressValidationStatusEnumValues)
}



// AssertAddressValidationStatusRequired checks if the required fields are not zero-ed
func AssertAddressValidationStatusRequired(obj AddressValidationStatus) error {
	return nil
}

// AssertAddressValidationStatusConstraints checks if the values respects the defined constraints
func AssertAddressValidationStatusConstraints(obj AddressValidationStatus) error {
	return nil
}
