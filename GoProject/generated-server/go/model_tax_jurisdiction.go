...
// AssertTaxJurisdictionRequired checks if the required fields are not zero-ed
func AssertTaxJurisdictionRequired(obj TaxJurisdiction) error {
...
// AssertTaxJurisdictionConstraints checks if the values respects the defined constraints
func AssertTaxJurisdictionConstraints(obj TaxJurisdiction) error {
	return nil
}
