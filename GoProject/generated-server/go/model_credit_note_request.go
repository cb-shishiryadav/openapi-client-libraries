...
// AssertCreditNoteRequestRequired checks if the required fields are not zero-ed
func AssertCreditNoteRequestRequired(obj CreditNoteRequest) error {
...
// AssertCreditNoteRequestConstraints checks if the values respects the defined constraints
func AssertCreditNoteRequestConstraints(obj CreditNoteRequest) error {
