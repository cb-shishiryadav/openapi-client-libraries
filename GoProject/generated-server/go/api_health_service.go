...
func (s *HealthAPIService) FetchHealth(ctx context.Context) (ImplResponse, error) {
	// TODO - update FetchHealth with the required logic for this service method.
	...
	return Response(http.StatusNotImplemented, nil), errors.New("FetchHealth method not implemented")
}
