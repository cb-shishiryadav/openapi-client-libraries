...
class TestTaxEstimationLineItemRequest(unittest.TestCase):
    """TaxEstimationLineItemRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxEstimationLineItemRequest:
        """Test TaxEstimationLineItemRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxEstimationLineItemRequest`
        """
        model = TaxEstimationLineItemRequest()
        if include_optional:
            return TaxEstimationLineItemRequest(
                number = 1,
                item_code = '',
                description = '',
                quantity = 0,
    ...
    def testTaxEstimationLineItemRequest(self):
        """Test TaxEstimationLineItemRequest"""
