...
class TaxEstimationResponse(BaseModel):
    """
    ...
    line_items: Annotated[List[InvoiceLineItem], Field(min_length=1, max_length=1250)] = Field(description="List of line item details for the tax estimation response.", alias="lineItems")
    __properties: ClassVar[List[str]] = ["seller", "customer", "estimateDateTime", "currency", "subtotal", "exemptAmount", "discountAmount", "taxableAmount", "taxAmount", "total", "lineItems"]
