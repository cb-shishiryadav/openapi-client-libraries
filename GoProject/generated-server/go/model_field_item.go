...
// AssertFieldItemRequired checks if the required fields are not zero-ed
func AssertFieldItemRequired(obj FieldItem) error {
...
// AssertFieldItemConstraints checks if the values respects the defined constraints
func AssertFieldItemConstraints(obj FieldItem) error {
	return nil
}
