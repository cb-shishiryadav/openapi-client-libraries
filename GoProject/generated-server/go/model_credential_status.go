...
// AllowedCredentialStatusEnumValues is all the allowed values of CredentialStatus enum
var AllowedCredentialStatusEnumValues = []CredentialStatus{
	"VALID",
	"INVALID",
}

// validCredentialStatusEnumValue provides a map of CredentialStatuss for fast verification of use input
var validCredentialStatusEnumValues = map[CredentialStatus]struct{}{
	"VALID": {},
	"INVALID": {},
}
...
func (v CredentialStatus) IsValid() bool {
	_, ok := validCredentialStatusEnumValues[v]
	return ok
}
...
func NewCredentialStatusFromValue(v string) (CredentialStatus, error) {
	...
	return "", fmt.Errorf("invalid value '%v' for CredentialStatus: valid values are %v", v, AllowedCredentialStatusEnumValues)
}



// AssertCredentialStatusRequired checks if the required fields are not zero-ed
func AssertCredentialStatusRequired(obj CredentialStatus) error {
	return nil
}

// AssertCredentialStatusConstraints checks if the values respects the defined constraints
func AssertCredentialStatusConstraints(obj CredentialStatus) error {
	return nil
}
