...
from openapi_server.models.document_status import DocumentStatus  # noqa: E501
...
class CreditNote(Model):
    ...
    def __init__(self, credit_note_id=None, credit_note_code=None, invoice_code=None, invoice_id=None, credit_note_type=None, document_date_time=None, tax_date_time=None, status=None, currency=None, seller=None, customer=None, discount_amount=None, subtotal=None, exempt_amount=None, taxable_amount=None, tax_amount=None, total=None, rounding_amount=None, line_items=None):  # noqa: E501
        ...
        :param credit_note_code: The credit_note_code of this CreditNote.  # noqa: E501
        :type credit_note_code: str
        :param invoice_code: The invoice_code of this CreditNote.  # noqa: E501
        :type invoice_code: str
        :param invoice_id: The invoice_id of this CreditNote.  # noqa: E501
        :type invoice_id: str
        :param credit_note_type: The credit_note_type of this CreditNote.  # noqa: E501
        :type credit_note_type: CreditNoteType
        :param document_date_time: The document_date_time of this CreditNote.  # noqa: E501
        :type document_date_time: datetime
        :param tax_date_time: The tax_date_time of this CreditNote.  # noqa: E501
        ...
        :type currency: str
        :param seller: The seller of this CreditNote.  # noqa: E501
        :type seller: Seller
        :param customer: The customer of this CreditNote.  # noqa: E501
        :type customer: Customer
        :param discount_amount: The discount_amount of this CreditNote.  # noqa: E501
        :type discount_amount: float
        :param subtotal: The subtotal of this CreditNote.  # noqa: E501
        :type subtotal: float
        :param exempt_amount: The exempt_amount of this CreditNote.  # noqa: E501
        :type exempt_amount: float
        :param taxable_amount: The taxable_amount of this CreditNote.  # noqa: E501
        :type taxable_amount: float
        :param tax_amount: The tax_amount of this CreditNote.  # noqa: E501
        :type tax_amount: float
        :param total: The total of this CreditNote.  # noqa: E501
        :type total: float
        :param rounding_amount: The rounding_amount of this CreditNote.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CreditNote':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CreditNote of this CreditNote.  # noqa: E501
        :rtype: CreditNote
        """
        return util.deserialize_model(dikt, cls)

    @property
    def credit_note_id(self) -> str:
        """Gets the credit_note_id of this CreditNote.

        The unique identifier of the credit note at the Tax Service Provider or Tax Service Adapter.  # noqa: E501
    ...
    def credit_note_id(self, credit_note_id: str):
        ...
        if credit_note_id is None:
            raise ValueError("Invalid value for `credit_note_id`, must not be `None`")  # noqa: E501

        self._credit_note_id = credit_note_id

    @property
    def credit_note_code(self) -> str:
        """Gets the credit_note_code of this CreditNote.

        The unique identifier of the credit note in Chargebee.  # noqa: E501

        :return: The credit_note_code of this CreditNote.
        :rtype: str
        """
    ...
    def credit_note_code(self, credit_note_code: str):
        """Sets the credit_note_code of this CreditNote.

        The unique identifier of the credit note in Chargebee.  # noqa: E501

        :param credit_note_code: The credit_note_code of this CreditNote.
        :type credit_note_code: str
        """
    ...
    def invoice_code(self, invoice_code: str):
        """Sets the invoice_code of this CreditNote.

        The unique identifier of the invoice in Chargebee to which this credit note belongs.  # noqa: E501

        :param invoice_code: The invoice_code of this CreditNote.
        :type invoice_code: str
        """
    ...
    def credit_note_type(self) -> CreditNoteType:
        """Gets the credit_note_type of this CreditNote.


        :return: The credit_note_type of this CreditNote.
    ...
    def credit_note_type(self, credit_note_type: CreditNoteType):
        """Sets the credit_note_type of this CreditNote.


        :param credit_note_type: The credit_note_type of this CreditNote.
        :type credit_note_type: CreditNoteType
        """
    ...
    def document_date_time(self) -> datetime:
        """Gets the document_date_time of this CreditNote.
        ...
        :return: The document_date_time of this CreditNote.
        :rtype: datetime
        """
    ...
    def document_date_time(self, document_date_time: datetime):
        """Sets the document_date_time of this CreditNote.

        The date and time at which the credit note was created in Chargebee. For example, if the value is 2022-10-28T15:36:28.129+05:30, then the timestamp represents October 28, 2022, at 15:36:28.129, with an offset of +05:30. This means that the time represented is 5 hours and 30 minutes ahead of UTC/GMT. In the case of a merchant site located in UTC, these data types would send a timestamp in the format 2022-11-11T15:40:44.65Z. This timestamp represents November 11, 2022, at 15:40:44.65, with the 'Z' indicating that the time is in UTC.  # noqa: E501

        :param document_date_time: The document_date_time of this CreditNote.
        :type document_date_time: datetime
        """
    ...
    def tax_date_time(self) -> datetime:
        """Gets the tax_date_time of this CreditNote.
        ...
        :return: The tax_date_time of this CreditNote.
        :rtype: datetime
        """
    ...
    def tax_date_time(self, tax_date_time: datetime):
        """Sets the tax_date_time of this CreditNote.

        The date and time at which the tax was applicable in Chargebee. For example, if the value is 2022-10-28T15:36:28.129+05:30, then the timestamp represents October 28, 2022, at 15:36:28.129, with an offset of +05:30. This means that the time represented is 5 hours and 30 minutes ahead of UTC/GMT.In the case of a merchant site located in UTC, these data types would send a timestamp in the format 2022-11-11T15:40:44.65Z. This timestamp represents November 11, 2022, at 15:40:44.65, with the 'Z' indicating that the time is in UTC.  # noqa: E501

        :param tax_date_time: The tax_date_time of this CreditNote.
        :type tax_date_time: datetime
        """
    ...
    def seller(self) -> Seller:
        """Gets the seller of this CreditNote.


        :return: The seller of this CreditNote.
        :rtype: Seller
        """
        return self._seller
    ...
    def seller(self, seller: Seller):
        """Sets the seller of this CreditNote.


        :param seller: The seller of this CreditNote.
        :type seller: Seller
        """
        if seller is None:
    ...
    def discount_amount(self) -> float:
        """Gets the discount_amount of this CreditNote.

        The total discount applied. This is the sum of all `lineItems.discount`.  # noqa: E501

        :return: The discount_amount of this CreditNote.
        :rtype: float
        """
    ...
    def discount_amount(self, discount_amount: float):
        """Sets the discount_amount of this CreditNote.

        The total discount applied. This is the sum of all `lineItems.discount`.  # noqa: E501

        :param discount_amount: The discount_amount of this CreditNote.
        :type discount_amount: float
        """
    ...
    def subtotal(self, subtotal: float):
        """Sets the subtotal of this CreditNote.

        The amount after discounts. This is the sum of all `lineItems.subtotal`.  # noqa: E501

        :param subtotal: The subtotal of this CreditNote.
        :type subtotal: float
        """
    ...
    def exempt_amount(self) -> float:
        """Gets the exempt_amount of this CreditNote.

        The amount exempted from tax.  # noqa: E501

        :return: The exempt_amount of this CreditNote.
        :rtype: float
        """
    ...
    def exempt_amount(self, exempt_amount: float):
        """Sets the exempt_amount of this CreditNote.

        The amount exempted from tax.  # noqa: E501

        :param exempt_amount: The exempt_amount of this CreditNote.
        :type exempt_amount: float
        """
    ...
    def taxable_amount(self) -> float:
        """Gets the taxable_amount of this CreditNote.

        The amount upon which the tax is calculated.  # noqa: E501

        :return: The taxable_amount of this CreditNote.
        :rtype: float
        """
    ...
    def taxable_amount(self, taxable_amount: float):
        """Sets the taxable_amount of this CreditNote.

        The amount upon which the tax is calculated.  # noqa: E501

        :param taxable_amount: The taxable_amount of this CreditNote.
        :type taxable_amount: float
        """
    ...
    def tax_amount(self) -> float:
        """Gets the tax_amount of this CreditNote.

        The total tax payable. This is the sum of all `lineItems.taxAmount`.  # noqa: E501

        :return: The tax_amount of this CreditNote.
        :rtype: float
        """
    ...
    def tax_amount(self, tax_amount: float):
        """Sets the tax_amount of this CreditNote.

        The total tax payable. This is the sum of all `lineItems.taxAmount`.  # noqa: E501

        :param tax_amount: The tax_amount of this CreditNote.
        :type tax_amount: float
        """
    ...
    def rounding_amount(self, rounding_amount: float):
        """Sets the rounding_amount of this CreditNote.

        The rounding amount added to the total amount to account for fractional correction.  # noqa: E501

        :param rounding_amount: The rounding_amount of this CreditNote.
        :type rounding_amount: float
        """
