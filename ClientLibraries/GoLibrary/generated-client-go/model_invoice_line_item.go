...
// GetTaxExemptType returns the TaxExemptType field value if set, zero value otherwise.
func (o *InvoiceLineItem) GetTaxExemptType() TaxExemptType {
	if o == nil || IsNil(o.TaxExemptType) {
		var ret TaxExemptType
		return ret
	}
	return *o.TaxExemptType
}

// GetTaxExemptTypeOk returns a tuple with the TaxExemptType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InvoiceLineItem) GetTaxExemptTypeOk() (*TaxExemptType, bool) {
	if o == nil || IsNil(o.TaxExemptType) {
		return nil, false
	}
	return o.TaxExemptType, true
}
...
// SetTaxExemptType gets a reference to the given TaxExemptType and assigns it to the TaxExemptType field.
func (o *InvoiceLineItem) SetTaxExemptType(v TaxExemptType) {
	o.TaxExemptType = &v
}

// GetTaxExemptReason returns the TaxExemptReason field value if set, zero value otherwise.
func (o *InvoiceLineItem) GetTaxExemptReason() string {
	if o == nil || IsNil(o.TaxExemptReason) {
		var ret string
		return ret
	}
	return *o.TaxExemptReason
}

// GetTaxExemptReasonOk returns a tuple with the TaxExemptReason field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InvoiceLineItem) GetTaxExemptReasonOk() (*string, bool) {
	if o == nil || IsNil(o.TaxExemptReason) {
		return nil, false
	}
	return o.TaxExemptReason, true
}
...
// SetTaxExemptReason gets a reference to the given string and assigns it to the TaxExemptReason field.
...
// GetIsPartialTax returns the IsPartialTax field value if set, zero value otherwise.
func (o *InvoiceLineItem) GetIsPartialTax() bool {
	if o == nil || IsNil(o.IsPartialTax) {
		var ret bool
		return ret
	}
	return *o.IsPartialTax
}

// GetIsPartialTaxOk returns a tuple with the IsPartialTax field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InvoiceLineItem) GetIsPartialTaxOk() (*bool, bool) {
	if o == nil || IsNil(o.IsPartialTax) {
		return nil, false
	}
	return o.IsPartialTax, true
}
...
// SetIsPartialTax gets a reference to the given bool and assigns it to the IsPartialTax field.
...
func (o InvoiceLineItem) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TaxExemptType) {
		toSerialize["taxExemptType"] = o.TaxExemptType
	}
	if !IsNil(o.TaxExemptReason) {
		toSerialize["taxExemptReason"] = o.TaxExemptReason
	}
	...
	if !IsNil(o.IsPartialTax) {
		toSerialize["isPartialTax"] = o.IsPartialTax
	}
