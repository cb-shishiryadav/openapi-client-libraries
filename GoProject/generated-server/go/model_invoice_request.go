...
// AssertInvoiceRequestRequired checks if the required fields are not zero-ed
func AssertInvoiceRequestRequired(obj InvoiceRequest) error {
...
// AssertInvoiceRequestConstraints checks if the values respects the defined constraints
func AssertInvoiceRequestConstraints(obj InvoiceRequest) error {
