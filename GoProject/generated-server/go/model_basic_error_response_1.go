...
// AssertBasicErrorResponse1Required checks if the required fields are not zero-ed
func AssertBasicErrorResponse1Required(obj BasicErrorResponse1) error {
...
// AssertBasicErrorResponse1Constraints checks if the values respects the defined constraints
func AssertBasicErrorResponse1Constraints(obj BasicErrorResponse1) error {
	return nil
}
