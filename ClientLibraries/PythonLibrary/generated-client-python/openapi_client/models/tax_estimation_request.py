...
class TaxEstimationRequest(BaseModel):
    ...
    line_items: Annotated[List[TaxEstimationLineItemRequest], Field(min_length=1, max_length=1250)] = Field(description="Contains the details of each line item in the tax estimation request.", alias="lineItems")
    __properties: ClassVar[List[str]] = ["seller", "customer", "estimateDateTime", "currency", "lineItems"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimateDateTime": obj.get("estimateDateTime"),
            "currency": obj.get("currency"),
            "lineItems": [TaxEstimationLineItemRequest.from_dict(_item) for _item in obj["lineItems"]] if obj.get("lineItems") is not None else None
        })
        return _obj
