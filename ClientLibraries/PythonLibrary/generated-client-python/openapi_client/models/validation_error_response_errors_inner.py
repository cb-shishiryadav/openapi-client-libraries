...
class ValidationErrorResponseErrorsInner(BaseModel):
    """
    ValidationErrorResponseErrorsInner
    """ # noqa: E501
    entity: Optional[Annotated[str, Field(strict=True, max_length=20)]] = Field(default=None, description="The target entity that has the invalid field or value.")
    entity_field: Optional[Annotated[str, Field(strict=True, max_length=250)]] = Field(default=None, description="The field of an entity that has the invalid value.", alias="entityField")
    code: ErrorCode
    message: Annotated[str, Field(strict=True, max_length=250)] = Field(description="A short message describing the reason for the error.")
    ...
    __properties: ClassVar[List[str]] = ["entity", "entityField", "code", "message", "helpUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entityField": obj.get("entityField"),
            "code": obj.get("code"),
